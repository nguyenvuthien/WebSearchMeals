<template>
    <div class="p-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
            <a href="#" v-for="ingredient of computedIngredients" :key="ingredient.idIngredient"
                @click.prevent="openIngredient(ingredient)" class="block bg-white rounded p-3 mb-3 shadow">
